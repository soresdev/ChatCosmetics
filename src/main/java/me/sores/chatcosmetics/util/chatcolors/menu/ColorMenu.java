package me.sores.chatcosmetics.util.chatcolors.menu;
...
public class ColorMenu extends Menu {
    ...
    private CosmeticChatColor selected;

    public ColorMenu(Player player, Profile profile) {
        this.player = player;
    ...
    public Map<Integer, Button> getButtons(Player player) {
        ...
        for(CosmeticChatColor color : CosmeticChatColor.values()){
    ...
    private void setSelected(CosmeticChatColor selected) {
